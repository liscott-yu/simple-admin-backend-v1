...
import org.scott.constant.StringConstant;
import org.scott.constant.enums.DataScopeEnum;
...
public class SecurityUtils {
    ...
    public static String getCurrentUsername() {
        ...
        if (authentication == null) {
            throw new BadRequestException(HttpStatus.UNAUTHORIZED, StringConstant.CODE_EMPTY_OR_EXPIRED);
        }
    ...
    public static Long getCurrentUserId() {
        ...
        // UserDetailsServiceImpl 中的属性名是 "userDto"
